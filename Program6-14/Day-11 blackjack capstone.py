...
def calculate_score(cards):
    ...
    # If the score is already over 21, remove the 11 and replace it with a 1. You might need to look up append()
    # and remove().
...
def play_game():
    ...
    # Hint 11: The score will need to be
    # rechecked with every new card drawn and the checks in Hint 9 need to be repeated until the game ends.
